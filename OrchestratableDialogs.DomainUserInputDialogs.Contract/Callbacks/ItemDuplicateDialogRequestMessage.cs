...
{
    public class ItemDuplicateDialogRequestMessage : BasePayloadableDialogRequestMessage<ItemDuplicateDialogRequest, ItemDuplicateDialogResult>
    {
        public ItemDuplicateDialogRequestMessage(string title, ItemDuplicateDialogRequest request, ItemDuplicateDialogResult result, object payload) : base(title, request, result, payload)
        {
        }
    }
}
